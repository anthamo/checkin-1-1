...
const BRANCHES = [
  { name: "Joie", angle: 0, color: "#f7da45", def: "La satisfaction d'un moment qui va bien, de la sérénité tranquille à l'extase qui déborde.", levels: [
  ...
  { name: "Confiance", angle: 45, color: "#5ed485", def: "Le sentiment de pouvoir s'appuyer sur quelqu'un ou quelque chose, sans avoir à se méfier.", levels: [
  ...
  { name: "Peur", angle: 90, color: "#66ccbe", def: "La réaction face à une menace, réelle ou anticipée, de la simple appréhension à la terreur.", levels: [
  ...
  { name: "Surprise", angle: 135, color: "#58aae4", def: "Ce que provoque l'inattendu, avant même de juger s'il est bon ou mauvais.", levels: [
  ...
  { name: "Tristesse", angle: 180, color: "#8074dc", def: "Le poids d'une perte ou d'un manque, de la songerie légère au chagrin profond.", levels: [
  ...
  { name: "Dégoût", angle: 225, color: "#cb79d8", def: "Le rejet de ce qui repousse, moralement ou physiquement, de l'ennui à l'aversion.", levels: [
  ...
  { name: "Colère", angle: 270, color: "#ec7765", def: "L'énergie d'une limite franchie, de la contrariété sourde à la rage.", levels: [
  ...
  { name: "Anticipation", angle: 315, color: "#f6a131", def: "L'attention tournée vers ce qui vient, de l'intérêt curieux à la vigilance tendue.", levels: [
