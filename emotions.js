...
const BRANCHES = [
  { name: "Joie", angle: 0, color: "#f7da45", def: "Ce que tu ressens quand quelque chose va dans le bon sens.", levels: [
    ...
    { word: "sérénité", desc: "Un calme posé, quand tu sens les choses sous contrôle.", qs: ["Qu'as-tu mis en place pour y arriver ?", "Qu'est-ce qui pourrait fragiliser ce calme ?"], deep: "De quoi as-tu eu besoin pour te sentir enfin posé·e ?" } ] },
  ...
  { name: "Dégoût", angle: 225, color: "#cb79d8", def: "Le rejet de ce qui te repousse ou heurte tes valeurs.", levels: [
    ...
    { word: "ennui",    desc: "La lassitude quand ce que tu fais n'a plus d'intérêt.", qs: ["Qu'est-ce qui a perdu son intérêt pour toi ?", "De quoi aurais-tu envie à la place ?"], deep: "Qu'est-ce qui te manque vraiment pour te sentir engagé·e ?" } ] },
  ...
  { name: "Anticipation", angle: 315, color: "#f6a131", def: "Ton attention tournée vers ce qui vient, ce que tu attends ou surveilles.", levels: [
    ...
    { word: "anticipation", desc: "Ton attente tournée vers une échéance ou une décision à venir.", qs: ["Qu'attends-tu de la suite ?", "Sur quoi peux-tu agir dès maintenant ?"], deep: "Qu'est-ce qui te rendrait plus serein·e face à l'inconnu ?" },
